...
- Create Angular project with ng: `ng new theburgerbackendproject2.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`theburgerbackendproject2.client.esproj`).
